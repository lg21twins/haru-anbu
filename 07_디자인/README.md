...
- **v3.0 (2026.05.09–10)**: 문서 IA를 M3·KRDS 패턴으로 재정렬. 흩어진 v2.0 문서 4개를 3개 파일로 통합. 로고 시스템·접근성·패턴 섹션 신설. 다국어(Noto Sans SC) 지원 추가. AI 진입점 = 하루안부 심볼로 일원화. 5개 시각화 페이지(preview-*.html) 신설. 기존 문서는 `_archive/2026-05-09/`에 보존.
