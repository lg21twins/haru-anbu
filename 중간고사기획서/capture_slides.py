#!/usr/bin/env python3
"""
하루안부 기획서 v12 — 슬라이드 전체 스크린샷
1920×1080 px, 50장, 스크린샷/ 폴더에 저장
"""
...
HTML_FILE = Path(__file__).parent / "하루안부_기획서_v12.html"
OUT_DIR   = Path(__file__).parent / "스크린샷"
...
async def main():
    async with async_playwright() as p:
        ...
        # 1920×1080 뷰포트 + body padding 0 → scale = 1920/1920 = 1 (정확히 1:1)
